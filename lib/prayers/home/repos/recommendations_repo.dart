...
export 'package:prayer_ml/api/recommendations_api.dart'
    show CollectionRecommendationAction;
...
class RecommendationRepo extends _$RecommendationRepo {
  ...
  Future<void> updateAction(
    ...
    var recommendationsApi = config.recommendationsApiClient;
    await recommendationsApi.updateAction(collectionId, action,
...
@riverpod
class PaginatedCollectionRecommendationNotifier
    extends _$PaginatedCollectionRecommendationNotifier
  ...
  @override
  Future<CursorPagingData<CollectionRecommendation>> build(
      int limit, RecommendationGroup recommendationGroup) {
    this.limit = limit;
  ...
  Future<CursorPagingData<CollectionRecommendation>> fetch(
    ...
    var recommendationsApi = config.recommendationsApiClient;
    final repository = await recommendationsApi
        .fetchRecommendationsForGroupType(recommendationGroup, pagination);
...
@riverpod
class PaginatedHistoricalRecommendationNotifier
    extends _$PaginatedHistoricalRecommendationNotifier
  ...
  /// Builds the initial state of the provider by fetching data with a null cursor.
  @override
  Future<CursorPagingData<HistoricalCollectionRecommendation>> build(
      int limit) {
    this.limit = limit;
    return fetch(cursor: null);
  }
  ...
  Future<CursorPagingData<HistoricalCollectionRecommendation>> fetch(
    ...
    var recommendationsApi = config.recommendationsApiClient;
    final repository =
        await recommendationsApi.getRecommendationHistory(pagination);
...
@riverpod
class PaginatedUnresolvedFollowupsNotifier
    extends _$PaginatedUnresolvedFollowupsNotifier
    with CursorPagingNotifierMixin<CollectionRecommendation> {
  @override
  late int limit;
  @override
  ...
  /// Builds the initial state of the provider by fetching data with a null cursor.
  @override
  Future<CursorPagingData<CollectionRecommendation>> build(int limit,
      {int lookbackDays = 30}) {
    this.limit = limit;
  ...
  Future<CursorPagingData<CollectionRecommendation>> fetch(
    ...
    var recommendationsApi = config.recommendationsApiClient;
    final repository = await recommendationsApi
        .getUnresolvedFollowups(pagination, lookbackDays: lookbackDays);
    var collections = repository.collections;
...
@riverpod
Future<List<PrayerRequest>> recentPrayerRequests(Ref ref, int collectionId,
    {int n = 5}) async {
  var config = Config();
  var recommendationsApi = config.recommendationsApiClient;

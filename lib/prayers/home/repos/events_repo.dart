...
@riverpod
Future<List<PrayerCollectionEvent>> fetchFutureEvents(Ref ref, {int limit = 10, int maxDays = 30}) async {
  var config = Config();
  var api = config.eventsApiClient;
  return await api.getFutureEvents(limit: limit, maxDays: maxDays);
}

          ...
          itemBuilder: (context, index) {
            if (index == filteredItems.length) {
              if (filteredItems.isEmpty) {
                return widget.config.readOnly ||
                        widget.config.groupContacts == null
              ...
              final lastDateRequests = filteredItems
                  .where((r) =>
                      daysBetween(DateTime.parse(r.createdAt),
            ...
            if (index > 0 &&
              ...
              final userRequests = filteredItems
                  .where((r) =>
                      r.user.id == filteredItems[index - 1].user.id &&
                      daysBetween(
              ...
              final userRequests = filteredItems
                  .where((r) =>
                      r.user.id == filteredItems[index - 1].user.id &&
                      daysBetween(DateTime.parse(r.createdAt),
                              DateTime.parse(filteredItems[index].createdAt)) ==
                          0)
                  .toList();
            ...
            if (index == 0 && !widget.config.readOnly) {
              ...
              if (daysBetween(DateTime.parse(filteredItems[index].createdAt),
                      DateTime.now()) >=
                  1) {
                ...
                final todayRequests = filteredItems
                    .where((r) =>
                        daysBetween(
                            DateTime.parse(r.createdAt), DateTime.now()) ==
                        0)
                    .toList();
